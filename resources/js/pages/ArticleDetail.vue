...
<div class="show">
    ...
    <div class="c-panel__container" >
        ...
        <a　v-if="article.user_id === currentUser.id" href="">
          <button class="p-comment__btn p-show__edit" @click="articleEdit">編集</button>
        </a>
...
<div v-if=" article.id !== currentUser.id">
    ...
    <div v-for="board in boards">
        ...
        <div v-if="board.user_id === currentUser.id" >
        ...
        <form class="" action="" method="post"  @submit.prevent="submit">
           ...
           <input type="hidden" name="_token" :value="csrf">
            ...
            <div class="text-right">
              <button type="submit" name="button" class="p-comment__btn btn-primary" @click="commentSubmit">投稿</button>
            </div>
